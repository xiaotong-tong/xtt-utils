const { toB64, toDataUrl } = require("xtt-utils");
require("expect-puppeteer");
const path = require("path");

describe("toB64 module", () => {
	beforeAll(async () => {
